...
multiplayer.modsNSM.host = new Jo([{
    ...
    items: [{
        ...
        bigChange: 1e4,
        smallChange: 1e3,
        display: () => 0 === Tt.mods.endPos ? Pt("end", xt) : Tt.mods.endPos
    }, {
        type: "number",
        name: "mods_offset",
...
c.multiplayer = function () {
    ...
    if (multiplayer.code != '') {
        ...
        if (!v.newGrabbedLevels[multiplayer.mapId]) {
            ...
            Kt(width / 3 + i, height / 16 + i + ((height - height / 16) / 3 - 2 * i) + i + ((height - height / 16) / 3 - 2 * i) + i, width / 3 * 2 - 2 * i, (height - height / 16) / 3 / 3 * 2 - i / 2, Pt(0 === h ? "menu_download" : 2 === h ? !multiplayer.isHost ? multiplayer.ready ? "menu_multiplayer_unready" : "menu_multiplayer_ready" : "menu_lvl_play" : "menu_downloading", xt), Bt.lvl.buttonHover, 4)
            multiplayer.isHost ?
                (Kt(width / 3 + i, height / 16 + i + ((height - height / 16) / 3 - 2 * i) + i + ((height - height / 16) / 3 - 2 * i) + i + (height - height / 16) / 3 / 3 * 2 + i / 2, (width / 3 * 2 - 4 * i) / 3, (height - height / 16) / 3 / 3 - i / 2, Pt("multiplayer_menu_play_spec", xt), Bt.lvl.buttonHover, 11),
                ...
                Kt(width / 3 + 3 * i + (width / 3 * 2 - 4 * i) / 3 * 2, height / 16 + i + ((height - height / 16) / 3 - 2 * i) + i + ((height - height / 16) / 3 - 2 * i) + i + (height - height / 16) / 3 / 3 * 2 + i / 2, (width / 3 * 2 - 4 * i) / 3, (height - height / 16) / 3 / 3 - i / 2, Pt("multiplayer_menu_select", xt), Bt.lvl.buttonHover, 3))

            :   (Kt(width / 3 + i, height / 16 + i + ((height - height / 16) / 3 - 2 * i) + i + ((height - height / 16) / 3 - 2 * i) + i + (height - height / 16) / 3 / 3 * 2 + i / 2, (width / 3 * 2 - 4 * i) / 2, (height - height / 16) / 3 / 3 - i / 2, Pt("multiplayer_menu_play_spec", xt), Bt.lvl.buttonHover, 11),
                Kt(width / 3 + 3 * i + (width / 3 * 2 - 4 * i) / 2, height / 16 + i + ((height - height / 16) / 3 - 2 * i) + i + ((height - height / 16) / 3 - 2 * i) + i + (height - height / 16) / 3 / 3 * 2 + i / 2, (width / 3 * 2 - 4 * i) / 2, (height - height / 16) / 3 / 3 - i / 2, Pt("menu_lvl_mods", xt), Bt.lvl.buttonHover, 12))

            // Show map metadata
            var i = width > height ? width / 64 : height / 64;
            fill(0, 25);
            rect(width / 3 + i, height / 16 + i, width / 3 * 2 / 3 * 2 - 2 * i, (height - height / 16) / 3 - 2 * i, i),
            imageMode(CENTER),
            Po(width / 3 + 2 * i + (((height - height / 16) / 3 - 2 * i) / 2 - i) / 2, height / 16 + 2 * i + (((height - height / 16) / 3 - 2 * i) / 2 - i) / 2, ((height - height / 16) / 3 - 2 * i) / 2 - i, ((height - height / 16) / 3 - 2 * i) / 2 - i, m(multiplayer.mapId, "id", true).stars, m(multiplayer.mapId, "id", true).ranked, m(multiplayer.mapId, "id", true).special),
            fill($.text),
            textAlign(LEFT, CENTER),
            Dt(H(multiplayer.mapId, "id").title, width / 3 + 3 * i + (((height - height / 16) / 3 - 2 * i) / 2 - i), height / 16 + 2 * i + (((height - height / 16) / 3 - 2 * i) / 2 - i) / 2, width / 3 * 2 / 3 * 2 - 2 * i - 3 * i - (((height - height / 16) / 3 - 2 * i) / 2 - i), ((height - height / 16) / 3 - 2 * i) / 2 - i, "bold");
            var o = Ut(H(multiplayer.mapId, "id").author, "uuid").user;
            Dt(Pt("menu_lvl_by", xt, void 0 === o ? Pt("defaultUsername", xt) : o), width / 3 + 2 * i, height / 16 + 2 * i + ((height - height / 16) / 3 - 2 * i) / 2, width / 3 * 2 / 3 * 2 - 2 * i - 2 * i, ((height - height / 16) / 3 - 2 * i) / 4 - i),
            Dt(Pt("menu_lvl_song", xt, Lt(H(multiplayer.mapId, "id").song, "id").artist, Lt(H(multiplayer.mapId, "id").song, "id").name), width / 3 + 2 * i, height / 16 + 1.5 * i + ((height - height / 16) / 3 - 2 * i) / 2 + ((height - height / 16) / 3 - 2 * i) / 4, width / 3 * 2 / 3 * 2 - 2 * i - 2 * i, ((height - height / 16) / 3 - 2 * i) / 4 - i),
            !0 === Lt(H(multiplayer.mapId, "id").song, "id").explicit && (imageMode(CORNER),
            Wt(St.explicit, "stretch", width / 3 + i + (width / 3 * 2 / 3 * 2 - 2 * i) - 2.25 * i, height / 16 + i + ((height - height / 16) / 3 - 2 * i) - 2.25 * i, 1.5 * i, 1.5 * i),
            Ft("rcorner", width / 3 + i + (width / 3 * 2 / 3 * 2 - 2 * i) - 2.25 * i, height / 16 + i + ((height - height / 16) / 3 - 2 * i) - 2.25 * i, 1.5 * i, 1.5 * i)) && ($t = Pt("explicit", xt)),
            fill(0, 25),
            rect(width / 3 + i + (width / 3 * 2 / 3 * 2 - 2 * i) + i, height / 16 + i, width / 3 * 2 / 3 - i, (height - height / 16) / 3 - 2 * i, i);
            textAlign(LEFT, CENTER);
            for (t = 0; t < 8; t++) {
                var o = ""
                , n = !1;
                0 === t ? o = void 0 === multiplayer.mapId ? Pt("menu_lvl_notUploaded", xt) : Pt("menu_lvl_ID", xt, multiplayer.mapId) : 1 === t ? (void 0 !== (o = H(multiplayer.mapId, "id").bpmDis) && (o = !0 === o[0] ? Pt("menu_lvl_foresight_range", xt, $i(o[1] * Tt.mods.bpm), $i(o[2] * Tt.mods.bpm)) : $i(o * Tt.mods.bpm)),
                o = Pt("menu_lvl_bpm", xt, o),
                1 !== Tt.mods.bpm && (n = !0)) : 2 === t ? (void 0 !== (o = H(multiplayer.mapId, "id").arDis) && (o = !0 === o[0] ? Pt("menu_lvl_foresight_range", xt, $i(o[1] * Tt.mods.foresight), $i(o[2] * Tt.mods.foresight)) : $i(o * Tt.mods.foresight)),
                o = Pt("menu_lvl_foresight", xt, o),
                1 !== Tt.mods.foresight && (n = !0)) : 3 === t ? (o = H(multiplayer.mapId, "id").hw,
                w = H(multiplayer.mapId, "id").ar,
                o = null == o ? w : o,
                o *= Tt.mods.hitWindow,
                o = Pt("menu_lvl_hitWindow", xt, $i(o)),
                1 !== Tt.mods.hitWindow && (n = !0)) : 4 === t ? (o = H(multiplayer.mapId, "id").hpD,
                o = Pt("menu_lvl_hpD", xt, $i(o))) : 5 === t ? (o = Wo(H(multiplayer.mapId, "id").len * (1 / Tt.mods.bpm), "min:sec"),
                o = Pt("menu_lvl_length", xt, o),
                1 !== Tt.mods.bpm && (n = !0)) : 6 === t ? o = Hn(floor(100 * Bn(multiplayer.mapId)) / 100) : 7 === t && (o = H(multiplayer.mapId, "id").ranked ? H(multiplayer.mapId, "id").special ? Pt("menu_lvl_special", xt) : Pt("menu_lvl_ranked", xt) : Pt("menu_lvl_unranked", xt)),
                n ? fill($.modText) : fill($.text),
                Dt(o, width / 3 + i + (width / 3 * 2 / 3 * 2 - 2 * i) + 2 * i, height / 16 + 1.75 * i + ((height - height / 16) / 3 - 4 * i) / 8 * (t + 1) - ((height - height / 16) / 3 - 3 * i) / 8 / 4, width / 3 * 2 / 3 - i - 2 * i, ((height - height / 16) / 3 - 4 * i) / 8)
            };
            fill(0, 25),
            rect(width / 3 + i, height / 16 + i + ((height - height / 16) / 3 - 2 * i) + i, width / 3 * 2 - 2 * i, (height - height / 16) / 3 - 2 * i, i),
            fill($.main),
            rect(width / 3 + i, height / 16 + i + ((height - height / 16) / 3 - 2 * i) + i + (((height - height / 16) / 3 - 2 * i) / 2 - i / 2 / 2), width / 3 * 2 - 2 * i, i / 2),
            fill($.text),
            textAlign(CENTER, CENTER);
            o = null == (o = H(multiplayer.mapId, "id").desc) ? "" : o,
            textSize(i / 1.25),
            text(0 < o.length ? '"' + o + '"' : Pt("menu_lvl_noDescription", xt), width / 3 * 2 - (width / 3 * 2 - 2 * i) / 2, height / 16 + i + ((height - height / 16) / 3 - 2 * i) + i + ((height - height / 16) / 3 - 2 * i + i / 2 / 2) / 2 / 2 - ((height - height / 16) / 3 - 2 * i + i / 2 / 2) / 2 / 2 - i / 2 / 2, width / 3 * 2 - 2 * i, ((height - height / 16) / 3 - 2 * i + i / 2 / 2) / 2),
            Dt(Pt("multiplayer_modsDesc", xt, multiplayer.selMods.bpm, multiplayer.selMods.hw), width / 3 * 2, height / 16 + i + ((height - height / 16) / 3 - 2 * i) + i + ((height - height / 16) / 3 - 2 * i + i / 2 / 2) / 2 / 2 + ((height - height / 16) / 3 - 2 * i + i / 2 / 2) / 2, width / 3 * 2 - 5 * i - 2 * i, ((height - height / 16) / 3 - 2 * i + i / 2 / 2) / 2 / 3);
            
            Bt.lvl.showMods ? Bt.lvl.modsX += At(1, Bt.lvl.modsX, .2) : Bt.lvl.modsX += At(0, Bt.lvl.modsX, .2),
            0 < Ot(100 * Bt.lvl.modsX) / 100 && (push(),
            translate(-(constrain(Bt.lvl.modsX, 0, 1) * (width / 3 * 2)), 0),
            fill(lerpColor($.shade, $.main, constrain(Bt.lvl.modsX, 0, 1))),
            rectMode(CORNER),
            ...
            fill(lerpColor($.shade, $.overlayShade, constrain(Bt.lvl.modsX, 0, 1))),
            rectMode(CORNER),
            rect(width / 3, height / 16 + ((height - height / 16) / 3 - 2 * i) + i + ((height - height / 16) / 3 - 2 * i) + i + (height - height / 16) / 3 / 3 * 2 + i / 2, width, (height - height / 16) / 3 / 3 - i / 2 + 2 * i),
            Kt(width / 3 + i + ((width / 3 * 2 - 2 * i) / 2 + i / 2), height / 16 + i + ((height - height / 16) / 3 - 2 * i) + i + ((height - height / 16) / 3 - 2 * i) + i + (height - height / 16) / 3 / 3 * 2 + i / 2 + ((height - height / 16) / 3 / 3 - i / 2) / 4 * 3 - i / 2, (width / 3 * 2 - 2 * i) / 2 - i / 2, ((height - height / 16) / 3 / 3 - i / 2) / 2, Pt("menu_back", xt), Bt.lvl.buttonHover, 11),
            multiplayer.isHost ? Kt(width / 3 + i + ((width / 3 * 2 - 2 * i) / 2 + i / 2), height / 16 + i + ((height - height / 16) / 3 - 2 * i) + i + ((height - height / 16) / 3 - 2 * i) + i + (height - height / 16) / 3 / 3 * 2 + i / 2 + ((height - height / 16) / 3 / 3 - i / 2) / 4 * 3 - i / 2 - ((height - height / 16) / 3 / 3 - i / 2) / 2 - i / 2, (width / 3 * 2 - 2 * i) / 2 - i / 2, ((height - height / 16) / 3 / 3 - i / 2) / 2, Pt("mods_practice", xt), Bt.lvl.buttonHover, 15) : void(0),
            fill($.text),
            textAlign(LEFT, CENTER),
            Dt(Pt("mods_scoreMultiplier", xt, wn(Tt.mods)), width / 3 + i, height / 16 + i + ((height - height / 16) / 3 - 2 * i) + i + ((height - height / 16) / 3 - 2 * i) + i + (height - height / 16) / 3 / 3 * 2 + i / 2 + ((height - height / 16) / 3 / 3 - i / 2) / 4 - i / 2, (width / 3 * 2 - 2 * i) / 2 - i / 2, ((height - height / 16) / 3 / 3 - i / 2) / 2),
            Kt(width / 3 + i, height / 16 + i + ((height - height / 16) / 3 - 2 * i) + i + ((height - height / 16) / 3 - 2 * i) + i + (height - height / 16) / 3 / 3 * 2 + i / 2 + ((height - height / 16) / 3 / 3 - i / 2) / 4 * 3 - i / 2, (width / 3 * 2 - 2 * i) / 2 - i / 2, ((height - height / 16) / 3 / 3 - i / 2) / 2, Pt("mods_reset", xt), Bt.lvl.buttonHover, 13),
            pop());
...
function Yo(e) {
    if ("lvl" === e) {
        for (var t = 0; t < Ht.saved.length; t++)
            !0 === Ht.saved[t].local && void 0 !== Ht.saved[t].id && (Ht.saved[t] = Ht.saved[t].id,
            Ht.onlineScores[Ht.saved[t]] = Ht.scores[t]);
        Bt.lvl.searchSent || (0 === Bt.lvl.search.length ? Io(0, "recent", Bt.lvl.tab, Bt.lvl.sortMode) : 0 !== Bt.lvl.search.length && Io(Bt.lvl.search, Bt.lvl.searchMode, Bt.lvl.tab, Bt.lvl.sortMode)),
        !0 !== Ne && (Rt = Uo(Ht.search, Bt.lvl.sortMode)),
        z = Bt.lvl.sel,
        Ve = Bt.lvl.tab
    } else
        "song" === e && (0 === O.search.length && (0 === Bt.song.search.length ? Ao(0, "recent", Bt.song.tab) : 0 !== Bt.song.search.length && Ao(Bt.song.search, Bt.song.searchMode, Bt.song.tab)),
        Rt = Uo(O.search, Bt.song.sortMode),
        z = Bt.song.sel,
        Ve = Bt.song.tab);
    var i = width > height ? width / 64 : height / 64;
    if (void 0 !== Rt[z]) {
        if ("lvl" === e) {
            ...
            rect(width / 3 + i, height / 16 + i, width / 3 * 2 / 3 * 2 - 2 * i, (height - height / 16) / 3 - 2 * i, i),
            imageMode(CENTER),
            Po(width / 3 + 2 * i + (((height - height / 16) / 3 - 2 * i) / 2 - i) / 2, height / 16 + 2 * i + (((height - height / 16) / 3 - 2 * i) / 2 - i) / 2, ((height - height / 16) / 3 - 2 * i) / 2 - i, ((height - height / 16) / 3 - 2 * i) / 2 - i, Bn(Rt[z]), H(Rt[z], "id").ranked, H(Rt[z], "id").special),
            fill($.text),
            textAlign(LEFT, CENTER),
            Dt((!0 === Rt[z].local ? Rt[z] : H(Rt[z], "id")).title, width / 3 + 3 * i + (((height - height / 16) / 3 - 2 * i) / 2 - i), height / 16 + 2 * i + (((height - height / 16) / 3 - 2 * i) / 2 - i) / 2, width / 3 * 2 / 3 * 2 - 2 * i - 3 * i - (((height - height / 16) / 3 - 2 * i) / 2 - i), ((height - height / 16) / 3 - 2 * i) / 2 - i, "bold");
            var o = (!0 === Rt[z].local ? Ut(Rt[z].author, "uuid") : Ut(H(Rt[z], "id").author, "uuid")).user;
            Dt(Pt("menu_lvl_by", xt, void 0 === o ? Pt("defaultUsername", xt) : o), width / 3 + 2 * i, height / 16 + 2 * i + ((height - height / 16) / 3 - 2 * i) / 2, width / 3 * 2 / 3 * 2 - 2 * i - 2 * i, ((height - height / 16) / 3 - 2 * i) / 4 - i),
            Dt(Pt("menu_lvl_song", xt, (!0 === Rt[z].local ? Lt(Rt[z].song, "id") : Lt(H(Rt[z], "id").song, "id")).artist, (!0 === Rt[z].local ? Lt(Rt[z].song, "id") : Lt(H(Rt[z], "id").song, "id")).name), width / 3 + 2 * i, height / 16 + 1.5 * i + ((height - height / 16) / 3 - 2 * i) / 2 + ((height - height / 16) / 3 - 2 * i) / 4, width / 3 * 2 / 3 * 2 - 2 * i - 2 * i, ((height - height / 16) / 3 - 2 * i) / 4 - i),
            !0 === Lt((!0 === Rt[z].local ? Rt[z] : H(Rt[z], "id")).song, "id").explicit && (imageMode(CORNER),
            Wt(St.explicit, "stretch", width / 3 + i + (width / 3 * 2 / 3 * 2 - 2 * i) - 2.25 * i, height / 16 + i + ((height - height / 16) / 3 - 2 * i) - 2.25 * i, 1.5 * i, 1.5 * i),
            Ft("rcorner", width / 3 + i + (width / 3 * 2 / 3 * 2 - 2 * i) - 2.25 * i, height / 16 + i + ((height - height / 16) / 3 - 2 * i) - 2.25 * i, 1.5 * i, 1.5 * i)) && ($t = Pt("explicit", xt)),
            fill(0, 25),
            rect(width / 3 + i + (width / 3 * 2 / 3 * 2 - 2 * i) + i, height / 16 + i, width / 3 * 2 / 3 - i, (height - height / 16) / 3 - 2 * i, i);
            ...
            for (t = 0; t < 8; t++) {
                var o = ""
                    , n = !1;
                0 === t ? o = void 0 === (o = !0 === Rt[z].local ? Rt[z].id : Rt[z]) ? Pt("menu_lvl_notUploaded", xt) + (void 0 !== Rt[z].copy ? " " + Pt("menu_lvl_copyID", xt, Rt[z].copy) : "") : Pt("menu_lvl_ID", xt, o) : 1 === t ? (!0 === Rt[z].local ? o = $i(Pn(Rt[z].beat, Rt[z].bpm)) : void 0 !== (o = H(Rt[z], "id").bpmDis) && (o = !0 === o[0] ? Pt("menu_lvl_foresight_range", xt, $i(o[1] * Tt.mods.bpm), $i(o[2] * Tt.mods.bpm)) : $i(o * Tt.mods.bpm)),
                o = Pt("menu_lvl_bpm", xt, o),
                1 !== Tt.mods.bpm && (n = !0)) : 2 === t ? (!0 === Rt[z].local ? o = $i(En(Rt[z].effects, Rt[z].ar)) : void 0 !== (o = H(Rt[z], "id").arDis) && (o = !0 === o[0] ? Pt("menu_lvl_foresight_range", xt, $i(o[1] * Tt.mods.foresight), $i(o[2] * Tt.mods.foresight)) : $i(o * Tt.mods.foresight)),
                o = Pt("menu_lvl_foresight", xt, o),
                1 !== Tt.mods.foresight && (n = !0)) : 3 === t ? (o = (!0 === Rt[z].local ? Rt[z] : H(Rt[z], "id")).hw,
                w = (!0 === Rt[z].local ? Rt[z] : H(Rt[z], "id")).ar,
                o = null == o ? w : o,
                o *= Tt.mods.hitWindow,
                o = Pt("menu_lvl_hitWindow", xt, $i(o)),
                1 !== Tt.mods.hitWindow && (n = !0)) : 4 === t ? (o = (!0 === Rt[z].local ? Rt[z] : H(Rt[z], "id")).hpD,
                o = Pt("menu_lvl_hpD", xt, $i(o))) : 5 === t ? (o = Wo((!0 === Rt[z].local ? Lo(Rt[z].beat, Rt[z].bpm) : H(Rt[z], "id").len) * (1 / Tt.mods.bpm), "min:sec"),
                o = Pt("menu_lvl_length", xt, o),
                1 !== Tt.mods.bpm && (n = !0)) : 6 === t ? o = Hn(floor(100 * Bn(Rt[z])) / 100) : 7 === t && (o = H(Rt[z], "id").ranked ? H(Rt[z], "id").special ? Pt("menu_lvl_special", xt) : Pt("menu_lvl_ranked", xt) : Pt("menu_lvl_unranked", xt)),
                n ? fill($.modText) : fill($.text),
                Dt(o, width / 3 + i + (width / 3 * 2 / 3 * 2 - 2 * i) + 2 * i, height / 16 + 1.75 * i + ((height - height / 16) / 3 - 4 * i) / 8 * (t + 1) - ((height - height / 16) / 3 - 3 * i) / 8 / 4, width / 3 * 2 / 3 - i - 2 * i, ((height - height / 16) / 3 - 4 * i) / 8)
            }
            fill($.lightTheme ? 0 : 255),
            ellipse(width / 3 + i + (width / 3 * 2 / 3 * 2 - 2 * i) + i + width / 3 * 2 / 3 - i - 1.5 * i, height / 16 + i + (height - height / 16) / 3 - 2 * i - 1.5 * i, 1.5 * i, 1.5 * i),
            Bt.lvl.refreshArrowR += At(0, Bt.lvl.refreshArrowR, .1),
            !Ft("ccenter", width / 3 + i + (width / 3 * 2 / 3 * 2 - 2 * i) + i + width / 3 * 2 / 3 - i - 1.5 * i, height / 16 + i + (height - height / 16) / 3 - 2 * i - 1.5 * i, 1.5 * i, 1.5 * i) || Bt.lvl.showLeaderboard || Bt.lvl.showMods || ($t = Pt("menu_lvl_refresh", xt),
            -.1 <= Bt.lvl.refreshArrowR && (Bt.lvl.refreshArrowR += At(-.1, Bt.lvl.refreshArrowR, .2))),
            push(),
            translate(width / 3 + i + (width / 3 * 2 / 3 * 2 - 2 * i) + i + width / 3 * 2 / 3 - i - 1.5 * i, height / 16 + i + (height - height / 16) / 3 - 2 * i - 1.5 * i),
            rotate(360 * Bt.lvl.refreshArrowR),
            imageMode(CENTER),
            Wt($.lightTheme ? St.refreshInvert : St.refresh, "stretch", 0, 0, .8 * i, .8 * i),
            pop(),
            fill(0, 25),
            rect(width / 3 + i, height / 16 + i + ((height - height / 16) / 3 - 2 * i) + i, width / 3 * 2 - 2 * i, (height - height / 16) / 3 - 2 * i, i),
            fill($.main),
            ...
            fill($.text),
            textAlign(CENTER, CENTER);
            o = null == (o = (!0 === Rt[z].local ? Rt[z] : H(Rt[z], "id")).desc) ? "" : o,
            textSize(i / 1.25),
            text(0 < o.length ? '"' + o + '"' : Pt("menu_lvl_noDescription", xt), width / 3 * 2 - (width / 3 * 2 - 2 * i) / 2, height / 16 + i + ((height - height / 16) / 3 - 2 * i) + i + ((height - height / 16) / 3 - 2 * i + i / 2 / 2) / 2 / 2 - ((height - height / 16) / 3 - 2 * i + i / 2 / 2) / 2 / 2 - i / 2 / 2, width / 3 * 2 - 2 * i, ((height - height / 16) / 3 - 2 * i + i / 2 / 2) / 2);
            var t = null;
            if (0 < Bt.lvl.leaderboardData.length)
                for (var s = 0; s < Bt.lvl.leaderboardData.length; s++)
                    s < Bt.lvl.leaderboardData.length && Bt.lvl.leaderboardData[s].user === T.uuid && (t = s);
            if (null !== t && !0 !== Rt[z].local && H(Rt[z], "id").ranked ? (push(),
            translate(0, height / 16 + i + ((height - height / 16) / 3 - 2 * i) + i + ((height - height / 16) / 3 - 2 * i + i / 2 / 2) / 2 / 2 - i / 4),
            noStroke(),
            fill($.text),
            rectMode(CENTER),
            textAlign(CENTER, CENTER),
            Dt(t + 1, width / 3 + 2.5 * i, height / 16 + i + (height - height / 16) / 16 * 0 + (height - height / 16) / 12 / 2, 2 * i, 2 * i, "bold"),
            imageMode(CENTER),
            x(Ut(Bt.lvl.leaderboardData[t].user, "uuid").pp) && Wt(_t(Ut(Bt.lvl.leaderboardData[t].user, "uuid").pp), "stretch", width / 3 + 5.5 * i, height / 16 + i + (height - height / 16) / 16 * 0 + (height - height / 16) / 12 / 2, 2 * i, 2 * i),
            textAlign(LEFT, CENTER),
            h = Ut(Bt.lvl.leaderboardData[t].user, "uuid").user,
            Dt(h = void 0 !== Bt.lvl.leaderboardData[t].mods && null !== Bt.lvl.leaderboardData[t].mods && Bt.lvl.leaderboardData[t].mods !== Tt.modsDef ? h + "\n" + Vo(Bt.lvl.leaderboardData[t].mods) : h, width / 3 + 7.5 * i + (width / 3 * 2 - 12 * i - i) / 4 - (width / 3 * 2 - 12 * i - i) / 2 / 2, height / 16 + i + (height - height / 16) / 16 * 0 + (height - height / 16) / 12 / 2, (width / 3 * 2 - i) / 2, 2 * i / 2),
            textAlign(RIGHT, CENTER),
            Dt(Ot(Bt.lvl.leaderboardData[t].score * wn(Bt.lvl.leaderboardData[t].mods)) + "\n" + Pt("performancePoints", xt, floor(100 * Bt.lvl.leaderboardData[t].performance) / 100), width / 3 + 8.5 * i + .75 * (width / 3 * 2 - 12 * i - i) + (width / 3 * 2 - 12 * i - i) / 2 / 2, height / 16 + i + (height - height / 16) / 16 * 0 + (height - height / 16) / 12 / 2, (width / 3 * 2 - 12 * i - i) / 2, 2 * i / 2),
            textAlign(CENTER, CENTER),
            h = constrain(tn(Bt.lvl.leaderboardData[t].score * wn(Bt.lvl.leaderboardData[t].mods) / rn(Rt[Bt.lvl.sel], "online")), 0, Tt.ranks.length - 1),
            fill(on(h)),
            Dt(Tt.ranks[h].symbol, width / 3 + 10.5 * i + (width / 3 * 2 - 12 * i - i), height / 16 + i + (height - height / 16) / 16 * 0 + (height - height / 16) / 12 / 2, 2 * i, 2 * i, "bold"),
            pop()) : !0 !== Rt[z].local && H(Rt[z], "id").ranked ? Dt(Pt("menu_lvl_noScore", xt), width / 3 * 2, height / 16 + i + ((height - height / 16) / 3 - 2 * i) + i + ((height - height / 16) / 3 - 2 * i + i / 2 / 2) / 2 / 2 + ((height - height / 16) / 3 - 2 * i + i / 2 / 2) / 2, width / 3 * 2 - 5 * i - 2 * i, ((height - height / 16) / 3 - 2 * i + i / 2 / 2) / 2 / 3) : Dt(Pt("menu_lvl_noLeaderboard", xt), width / 3 * 2, height / 16 + i + ((height - height / 16) / 3 - 2 * i) + i + ((height - height / 16) / 3 - 2 * i + i / 2 / 2) / 2 / 2 + ((height - height / 16) / 3 - 2 * i + i / 2 / 2) / 2, width / 3 * 2 - 5 * i - 2 * i, ((height - height / 16) / 3 - 2 * i + i / 2 / 2) / 2 / 3),
            !0 === Rt[z].local ? (Kt(width / 3 + i, height / 16 + i + ((height - height / 16) / 3 - 2 * i) + i + ((height - height / 16) / 3 - 2 * i) + i, (width / 3 * 2 - 2 * i) / 2 - i / 2, (height - height / 16) / 3 / 3 * 2 - i / 2, Pt("menu_lvl_play", xt), Bt.lvl.buttonHover, 0),
            Kt(width / 3 + i + ((width / 3 * 2 - 2 * i) / 2 - i / 2) + i, height / 16 + i + ((height - height / 16) / 3 - 2 * i) + i + ((height - height / 16) / 3 - 2 * i) + i, (width / 3 * 2 - 2 * i) / 2 - i / 2, (height - height / 16) / 3 / 3 * 2 - i / 2, Pt("menu_lvl_edit", xt), Bt.lvl.buttonHover, 2),
            Kt(width / 3 + i, height / 16 + i + ((height - height / 16) / 3 - 2 * i) + i + ((height - height / 16) / 3 - 2 * i) + i + (height - height / 16) / 3 / 3 * 2 + i / 2, (width / 3 * 2 - 4 * i) / 3, (height - height / 16) / 3 / 3 - i / 2, Pt("menu_lvl_delete", xt), Bt.lvl.buttonHover, 1),
            Kt(width / 3 + 2 * i + (width / 3 * 2 - 4 * i) / 3, height / 16 + i + ((height - height / 16) / 3 - 2 * i) + i + ((height - height / 16) / 3 - 2 * i) + i + (height - height / 16) / 3 / 3 * 2 + i / 2, (width / 3 * 2 - 4 * i) / 3, (height - height / 16) / 3 / 3 - i / 2, Pt("menu_lvl_mods", xt), Bt.lvl.buttonHover, 12),
            ...
            !0 === H(Rt[Bt.lvl.sel], "id").ranked ? Kt(width / 3 + 3 * i + (width / 3 * 2 - 4 * i) / 3 * 2, height / 16 + i + ((height - height / 16) / 3 - 2 * i) + i + ((height - height / 16) / 3 - 2 * i) + i + (height - height / 16) / 3 / 3 * 2 + i / 2, (width / 3 * 2 - 4 * i) / 3, (height - height / 16) / 3 / 3 - i / 2, Pt("menu_lvl_leaderboard", xt), Bt.lvl.buttonHover, 8) : "Metadata" !== H(Rt[Bt.lvl.sel], "id").beat && Kt(width / 3 + 3 * i + (width / 3 * 2 - 4 * i) / 3 * 2, height / 16 + i + ((height - height / 16) / 3 - 2 * i) + i + ((height - height / 16) / 3 - 2 * i) + i + (height - height / 16) / 3 / 3 * 2 + i / 2, (width / 3 * 2 - 4 * i) / 3, (height - height / 16) / 3 / 3 - i / 2, Pt("edit_select_item_copy", xt), Bt.lvl.buttonHover, 8)),
            !0 !== Rt[z].local && H(Rt[z], "id").special && Ft("rcorner", width / 3 + i, height / 16 + i + ((height - height / 16) / 3 - 2 * i) + i + ((height - height / 16) / 3 - 2 * i) + i, width / 3 * 2 - 2 * i, (height - height / 16) / 3 / 3 * 2 - i / 2) && !1 === Bt.lvl.showLeaderboard && !1 === Bt.lvl.showMods && ($t = Pt("menu_lvl_specialWarning", xt)),
            Bt.lvl.showLeaderboard ? (Bt.lvl.leaderboardX += At(1, Bt.lvl.leaderboardX, .2),
            !Rt[Bt.lvl.sel].local && !0 === H(Rt[Bt.lvl.sel], "id").ranked || (Bt.lvl.showLeaderboard = !1)) : Bt.lvl.leaderboardX += At(0, Bt.lvl.leaderboardX, .2),
            0 < Ot(100 * Bt.lvl.leaderboardX) / 100 && (push(),
            translate(-(constrain(Bt.lvl.leaderboardX, 0, 1) * (width / 3 * 2)), 0),
            fill(lerpColor($.shade, $.main, constrain(Bt.lvl.leaderboardX, 0, 1))),
            rectMode(CORNER),
            rect(width, height / 16, width / 3 * 2, height),
            push(),
            translate(width / 3 * 2, 0),
            ...
            fill(lerpColor($.shade, $.overlayShade, constrain(Bt.lvl.leaderboardX, 0, 1))),
            rectMode(CORNER),
            rect(width / 3, 0, width, h),
            h = h - i,
            translate(width / 3, 0),
            "Loading..." !== Bt.lvl.leaderboardData && Kt(width / 3 - width / 6 - i / 2, i / 2, width / 6, h, Pt("refresh", xt), Bt.lvl.buttonHover, 14),
            Kt(width / 3 + i / 2, i / 2, width / 6, h, Pt("menu_back", xt), Bt.lvl.buttonHover, 9),
            pop()),
            Bt.lvl.showMods ? Bt.lvl.modsX += At(1, Bt.lvl.modsX, .2) : Bt.lvl.modsX += At(0, Bt.lvl.modsX, .2),
            0 < Ot(100 * Bt.lvl.modsX) / 100 && (push(),
            translate(-(constrain(Bt.lvl.modsX, 0, 1) * (width / 3 * 2)), 0),
            ...
            rect(width / 3, height / 16 + ((height - height / 16) / 3 - 2 * i) + i + ((height - height / 16) / 3 - 2 * i) + i + (height - height / 16) / 3 / 3 * 2 + i / 2, width, (height - height / 16) / 3 / 3 - i / 2 + 2 * i),
            Kt(width / 3 + i + ((width / 3 * 2 - 2 * i) / 2 + i / 2), height / 16 + i + ((height - height / 16) / 3 - 2 * i) + i + ((height - height / 16) / 3 - 2 * i) + i + (height - height / 16) / 3 / 3 * 2 + i / 2 + ((height - height / 16) / 3 / 3 - i / 2) / 4 * 3 - i / 2, (width / 3 * 2 - 2 * i) / 2 - i / 2, ((height - height / 16) / 3 / 3 - i / 2) / 2, Pt("menu_back", xt), Bt.lvl.buttonHover, 11),
            Kt(width / 3 + i + ((width / 3 * 2 - 2 * i) / 2 + i / 2), height / 16 + i + ((height - height / 16) / 3 - 2 * i) + i + ((height - height / 16) / 3 - 2 * i) + i + (height - height / 16) / 3 / 3 * 2 + i / 2 + ((height - height / 16) / 3 / 3 - i / 2) / 4 * 3 - i / 2 - ((height - height / 16) / 3 / 3 - i / 2) / 2 - i / 2, (width / 3 * 2 - 2 * i) / 2 - i / 2, ((height - height / 16) / 3 / 3 - i / 2) / 2, Pt("mods_practice", xt), Bt.lvl.buttonHover, 15),
            fill($.text),
            textAlign(LEFT, CENTER),
            Dt(Pt("mods_scoreMultiplier", xt, wn(Tt.mods)), width / 3 + i, height / 16 + i + ((height - height / 16) / 3 - 2 * i) + i + ((height - height / 16) / 3 - 2 * i) + i + (height - height / 16) / 3 / 3 * 2 + i / 2 + ((height - height / 16) / 3 / 3 - i / 2) / 4 - i / 2, (width / 3 * 2 - 2 * i) / 2 - i / 2, ((height - height / 16) / 3 / 3 - i / 2) / 2),
            Kt(width / 3 + i, height / 16 + i + ((height - height / 16) / 3 - 2 * i) + i + ((height - height / 16) / 3 - 2 * i) + i + (height - height / 16) / 3 / 3 * 2 + i / 2 + ((height - height / 16) / 3 / 3 - i / 2) / 4 * 3 - i / 2, (width / 3 * 2 - 2 * i) / 2 - i / 2, ((height - height / 16) / 3 / 3 - i / 2) / 2, Pt("mods_reset", xt), Bt.lvl.buttonHover, 13),
            pop()),
            vt.trans += At(vt.active ? 1 : 0, vt.trans, .2),
            0 < Math.round(100 * vt.trans) / 100) {
                ...
                var r = width / 3 * 2
                    ...
                    , l = height / 16
                    , d = (translate(a, l),
                fill(lerpColor($.shade, $.main, constrain(vt.trans, 0, 1))),
                rectMode(CORNER),
                rect(0, 0, r, h),
                r - 2 * i)
                ...
                for (let e = 0; e < vt.sections.length; e++) {
                    ...
                    var c = g * (e + .5);
                    translate(0, c),
                    fill(lerpColor($.main, e % 2 != 0 ? $.main : $.shade, .5)),
                    rect(0, -g / 2, r, g),
                    pop()
                }
                fill($.text),
                ...
                for (let e = 0; e < vt.sections.length; e++) {
                    ...
                    d / 2 / 2)
                        , v = g / 1.5;
                    e !== vt.sections.length - 1 && (Kt(d / 2 + i / 2, -v / 2, u, v, Pt("practice_startAt", xt), vt.buttonHover, 2 * e, {
                        alert: Tt.mods.startPos === P.startMS
                    }),
                    Ft("rcorner", d / 2 + i / 2 + a, -v / 2 + l + f, u, v)) && (vt.callback = () => {
                        vt.buttonHover[2 * e] /= 4,
                        Tt.mods.startPos = P.startMS,
                        console.log("Start " + P.name)
                    }
                    ),
                    0 !== e && (Kt(d / 2 + i + u, -v / 2, u, v, Pt("practice_endBefore", xt), vt.buttonHover, 2 * e + 1, {
                        alert: Tt.mods.endPos === P.startMS
                    }),
                    Ft("rcorner", d / 2 + i + u + a, -v / 2 + l + f, u, v)) && (vt.callback = () => {
                ...
                fill(lerpColor($.shade, $.overlayShade, constrain(vt.trans, 0, 1))),
                rect(0, h / 8 * 7, r, h / 7);
                var m = r / 2 - 2 * i
                    , p = h / 8 / 1.5;
                Kt(r - m - i, h - h / 8 + (h / 8 - p) / 2, m, p, Pt("menu_back", xt), vt.buttonHover, -1),
                Ft("rcorner", r - m - i + a, h - h / 8 + (h / 8 - p) / 2 + l, m, p) && (vt.callback = () => vt.active = !1),
                pop()
            }
            !0 === Rt[z].local ? Ht.localOffsets[Ht.saved.indexOf(Rt[z])] = Tt.mods.offset : Ht.onlineOffsets[Rt[z]] = Tt.mods.offset
        } else
            "song" === e && (fill(0, 25),
            rect(width / 3 + i, height / 16 + i, width / 3 * 2 - 2 * i, (height - height / 16) / 3 - 2 * i, i),
            !0 === Lt(Rt[Bt.song.sel], "id").explicit && (Wt(St.explicit, "stretch", width / 3 + i + (width / 3 * 2 - 2 * i) - 2.25 * i, height / 16 + i + ((height - height / 16) / 3 - 2 * i) - 2.25 * i, 1.5 * i, 1.5 * i),
            Ft("rcorner", width / 3 + i + (width / 3 * 2 - 2 * i) - 2.25 * i, height / 16 + i + ((height - height / 16) / 3 - 2 * i) - 2.25 * i, 1.5 * i, 1.5 * i)) && ($t = Pt("explicit", xt)),
            textAlign(CENTER, CENTER),
            fill($.text),
            Dt(Pt("menu_lvl_song_list", xt, Lt(Rt[Bt.song.sel], "id").artist, Lt(Rt[Bt.song.sel], "id").name), width / 3 + i + (width / 3 * 2 - 2 * i) / 2, height / 16 + i + ((height - height / 16) / 3 - 2 * i) / 2, width / 3 * 2 - 2 * i - 2 * i, ((height - height / 16) / 3 - 2 * i) / 3),
            Dt(Pt("menu_lvl_ID", xt, Rt[Bt.song.sel]), width / 3 + i + (width / 3 * 2 - 2 * i) / 2, height / 16 + i + ((height - height / 16) / 3 - 2 * i) / 2 + ((height - height / 16) / 3 - 2 * i) / 3 / 2 + i, width / 3 * 2 - 2 * i - 2 * i, ((height - height / 16) / 3 - 2 * i) / 3 / 2),
            fill(0, 25),
            rect(width / 3 + i, height / 16 + i + ((height - height / 16) / 3 - 2 * i) + i, width / 3 * 2 - 2 * i, (height - height / 16) / 3 - 2 * i, i),
            Bt.song.songObject = soundManager.getSoundById(Rt[z]),
            imageMode(CORNER),
            Bt.song.listening ? 3 === Bt.song.songObject.readyState ? image(1 === Bt.settings.themeSel ? St.stopInvert : St.stop, width / 3 + i + i, height / 16 + i + ((height - height / 16) / 3 - 2 * i) + i + ((height - height / 16) / 3 - 2 * i) / 2 - i, 2 * i, 2 * i) : (Bt.song.loadR += .25,
            Bt.song.loadR = Bt.song.loadR % 360,
            push(),
            fill($.text),
            translate(width / 3 + i + i, height / 16 + i + ((height - height / 16) / 3 - 2 * i) + i + ((height - height / 16) / 3 - 2 * i) / 2 - i),
            translate(2 * i / 2, 2 * i / 2),
            rotate(Bt.song.loadR),
            rectMode(CENTER),
            rect(0, 0, 2 * i, 2 * i),
            pop()) : image(1 === Bt.settings.themeSel ? St.playInvert : St.play, width / 3 + i + i, height / 16 + i + ((height - height / 16) / 3 - 2 * i) + i + ((height - height / 16) / 3 - 2 * i) / 2 - i, 2 * i, 2 * i),
            rectMode(CORNER),
            fill($.textDown),
            rect(width / 3 + i + i + (i + 2 * i), height / 16 + i + ((height - height / 16) / 3 - 2 * i) + i + ((height - height / 16) / 3 - 2 * i) / 2 - i / 4 / 2, width / 3 * 2 - 4 * i - (i + 2 * i), i / 4, i / 4),
            void 0 !== Bt.song.songObject && 3 === Bt.song.songObject.readyState && (mouseIsPressed && Ft("rcorner", width / 3 + i + i + (i + 2 * i), height / 16 + i + ((height - height / 16) / 3 - 2 * i) + i + ((height - height / 16) / 3 - 2 * i) / 2 - i / 4 / 2 - i / 2, width / 3 * 2 - 4 * i - (i + 2 * i), i) ? (soundManager.setPosition(Rt[z], (mouseX - (width / 3 + i + i + (i + 2 * i))) / (width / 3 * 2 - 4 * i - (i + 2 * i)) * Bt.song.songObject.duration),
            soundManager.setVolume(Rt[z], 0)) : soundManager.setVolume(Rt[z], Bt.settings.musicVolume),
            (0 === Bt.song.songObject.playState || Bt.song.songObject.paused) && Bt.song.listening && soundManager.play(Rt[z]),
            textAlign(LEFT, CENTER),
            fill($.text),
            Dt(Wo(Bt.song.songObject.position, "min:sec") + "/" + Wo(Bt.song.songObject.duration, "min:sec"), width / 3 + i + i + (i + 2 * i), height / 16 + i + ((height - height / 16) / 3 - 2 * i) + i + ((height - height / 16) / 3 - 2 * i) / 2 - i / 4 / 2 + 1.5 * i, width / 3 * 2 - 4 * i - (i + 2 * i), i),
            mouseIsPressed ? (Bt.song.playbackX += At(Bt.song.songObject.position / Bt.song.songObject.duration, Bt.song.playbackX, .4),
            Bt.song.playbackR += At(Bt.song.songObject.position / Bt.song.songObject.duration * 742.5, Bt.song.playbackR, .4)) : (Bt.song.playbackX += At(Bt.song.songObject.position / Bt.song.songObject.duration, Bt.song.playbackX, .1 / (21e4 / Bt.song.songObject.duration)),
            Bt.song.playbackR += At(Bt.song.songObject.position / Bt.song.songObject.duration * 742.5, Bt.song.playbackR, .1 / (21e4 / Bt.song.songObject.duration))),
            Ft("rcenter", width / 3 + i + i + (i + 2 * i) + (width / 3 * 2 - 4 * i - (i + 2 * i)) * Bt.song.playbackX, height / 16 + i + ((height - height / 16) / 3 - 2 * i) + i + ((height - height / 16) / 3 - 2 * i) / 2 - i / 4 / 2 + i / 8, i, i) ? mouseIsPressed ? Bt.song.playbackS += At(1.25, Bt.song.playbackS, .2) : Bt.song.playbackS += At(1, Bt.song.playbackS, .2) : Bt.song.playbackS += At(.75, Bt.song.playbackS, .2),
            push(),
            translate(width / 3 + i + i + (i + 2 * i), height / 16 + i + ((height - height / 16) / 3 - 2 * i) + i + ((height - height / 16) / 3 - 2 * i) / 2 - i / 4 / 2),
            translate((width / 3 * 2 - 4 * i - (i + 2 * i)) * Bt.song.playbackX, i / 8),
            ...
            rect(0, 0, i, i),
            pop()),
            Kt(width / 3 + i, height / 16 + i + ((height - height / 16) / 3 - 2 * i) + i + ((height - height / 16) / 3 - 2 * i) + i, width / 3 * 2 - 2 * i, (height - height / 16) / 3 / 3 * 2 - i / 2, Pt("menu_song_copyID", xt), Bt.song.buttonHover, 4),
            Kt(width / 3 + i, height / 16 + i + ((height - height / 16) / 3 - 2 * i) + i + ((height - height / 16) / 3 - 2 * i) + i + (height - height / 16) / 3 / 3 * 2 + i / 2, width / 3 * 2 - 2 * i, (height - height / 16) / 3 / 3 - i / 2, -1 !== O.saved.indexOf(Rt[z]) ? Pt("menu_lvl_unbookmark", xt) : Pt("menu_lvl_bookmark", xt), Bt.song.buttonHover, 5));
        Bt.lvl.deleteConfirm || Bt.lvl.uploadConfirm ? Bt.lvl.deleteBanner += At(1, Bt.lvl.deleteBanner, .2) : Bt.lvl.deleteBanner += At(0, Bt.lvl.deleteBanner, .2),
        push(),
        rectMode(CORNER),
        fill($.overlayShade),
        rect(-width / 3 * 2 + width / 3 * 3 * Bt.lvl.deleteBanner, height - (height - height / 16) / 3 - 1.5 * i, width / 3 * 2, (height - height / 16) / 3 + i),
        fill($.text),
        Kt(-width / 3 * 2 + i + width / 3 * 3 * Bt.lvl.deleteBanner, height / 16 + i + ((height - height / 16) / 3 - 2 * i) + i + ((height - height / 16) / 3 - 2 * i) + i + (height - height / 16) / 3 / 3 * 2 + i / 2, (width / 3 * 2 - 2 * i) / 2 - i / 2, (height - height / 16) / 3 / 3 - i / 2, Pt(Bt.lvl.uploadConfirm ? "menu_lvl_upload_yes" : "menu_lvl_delete_yes", xt), Bt.lvl.buttonHover, 6),
        Kt(-width / 3 * 2 + i + ((width / 3 * 2 - 2 * i) / 2 - i / 2) + i + width / 3 * 3 * Bt.lvl.deleteBanner, height / 16 + i + ((height - height / 16) / 3 - 2 * i) + i + ((height - height / 16) / 3 - 2 * i) + i + (height - height / 16) / 3 / 3 * 2 + i / 2, (width / 3 * 2 - 2 * i) / 2 - i / 2, (height - height / 16) / 3 / 3 - i / 2, Pt("menu_lvl_delete_no", xt), Bt.lvl.buttonHover, 7),
        push(),
        translate((width / 3 * 2 - 2 * i) / 2 + width / 3 * 3 * Bt.lvl.deleteBanner, ((height - height / 16) / 3 / 3 * 2 - i / 2) / 2),
        fill($.text),
        Dt(Pt(Bt.lvl.uploadConfirm ? void 0 === Rt[Bt.lvl.sel].copy ? "menu_lvl_upload_confirm" : "menu_lvl_uploadUpdate_confirm" : "menu_lvl_delete_confirm", xt, Rt[z].title), -width / 3 * 2 + i, height / 16 + i + ((height - height / 16) / 3 - 2 * i) + i + ((height - height / 16) / 3 - 2 * i) + i, width / 3 * 2 - 2 * i, ((height - height / 16) / 3 / 3 * 2 - i / 2) / 1.5),
        pop(),
        pop()
    }
    rectMode(CORNER),
    ...
    for (t = 0; t < Rt.length; t++) {
        var b = height / 16 + height / 24 + height / 12 * t - (Rt.length > (height - (height / 16 + height / 24)) / (height / 12) ? Bt.lvl.scroll / (height - (height / 16 + height / 24) - (height - (height / 16 + height / 24)) / 12) * (height / 12 * (Rt.length - (height - (height / 16 + height / 24)) / (height / 12))) : 0);
        b < height && 0 < b && (push(),
        translate(0, b),
        z === t ? fill($.select) : fill(lerpColor(t % 2 != 0 ? $.shade : $.overlayShade, color(0, 0, 0), .15)),
        rect(0, 0, width / 3, height / 12),
        "lvl" === e ? (imageMode(CENTER),
        Po((width < height ? width : height) / 16 / 2 + i / 4, height / 12 / 2, (width < height ? width : height) / 16, (width < height ? width : height) / 16, Bn(Rt[t]), H(Rt[t], "id").ranked, H(Rt[t], "id").special),
        push(),
        translate((width < height ? width : height) / 16 + i / 4 * 2, 0),
        textAlign(LEFT, CENTER),
        fill($.text),
        Dt((!0 === Rt[t].local ? Rt[t] : H(Rt[t], "id")).title, 0, height / 12 / 4, width / 3 - width / 48 - ((width < height ? width : height) / 16 + i / 4 * 4), height / 12 / 2 / 1.5, "bold"),
        o = (!0 === Rt[t].local ? Ut(Rt[t].author, "uuid") : Ut(H(Rt[t], "id").author, "uuid")).user,
        Dt(Pt("menu_lvl_by", xt, void 0 === o ? Pt("defaultUsername", xt) : o), 0, height / 12 / 2 + height / 12 / 16, width / 3 - width / 48 - ((width < height ? width : height) / 16 + i / 4 * 4), height / 12 / 4 / 1.5),
        Dt(Pt("menu_lvl_song_list", xt, (!0 === Rt[t].local ? Lt(Rt[t].song, "id") : Lt(H(Rt[t], "id").song, "id")).artist, (!0 === Rt[t].local ? Lt(Rt[t].song, "id") : Lt(H(Rt[t], "id").song, "id")).name), 0, height / 12 / 2 + height / 12 / 4, width / 3 - width / 48 - ((width < height ? width : height) / 16 + i / 4 * 4), height / 12 / 4 / 1.5),
        pop(),
        void 0 === Lt((!0 === Rt[t].local ? Rt[t] : H(Rt[t], "id")).song, "id").name && (Rt[t].song = 1203),
        !0 === Lt((!0 === Rt[t].local ? Rt[t] : H(Rt[t], "id")).song, "id").explicit && (imageMode(CENTER),
        Wt(St.explicit, "stretch", i / 2 + (width / 3 - width / 48 - i - 1.25 * i), height / 12 / 2, Ot(1.5 * i), Ot(1.5 * i)),
        Ft("rcenter", i / 2 + (width / 3 - width / 48 - i - 1.25 * i), height / 12 / 2 + b, Ot(1.5 * i), Ot(1.5 * i))) && ($t = Pt("explicit", xt))) : "song" === e && (fill($.text),
        textAlign(LEFT, CENTER),
        Dt(Pt("menu_lvl_song_list", xt, Lt(Rt[t], "id").artist, Lt(Rt[t], "id").name), i / 2, height / 12 / 2, width / 3 - width / 48 - i - (!0 === Lt(Rt[t], "id").explicit ? 3 * i : 0), height / 12 - i),
        imageMode(CENTER),
        !0 === Lt(Rt[t], "id").explicit) && (Wt(St.explicit, "stretch", i / 2 + (width / 3 - width / 48 - i - 1.25 * i), height / 12 / 2, Ot(1.5 * i), Ot(1.5 * i)),
        Ft("rcenter", i / 2 + (width / 3 - width / 48 - i - 1.25 * i), height / 12 / 2 + b, Ot(1.5 * i), Ot(1.5 * i))) && ($t = Pt("explicit", xt)),
        pop())
    }
    fill(30),
    rect(width / 3 - width / 48, height / 16, width / 48, height),
    fill($.scrollbar),
    rect(width / 3 - width / 48, height / 16 + height / 24 + Bt.lvl.scroll, width / 48, (height - (height / 16 + height / 24)) / 12),
    mouseIsPressed && (Ft("rcorner", width / 3 - width / 48, height / 16 + height / 24 + Bt.lvl.scroll, width / 48, (height - (height / 16 + height / 24)) / 12) ? (Bt.lvl.scroll += mouseY - pmouseY,
    Bt.lvl.scrollNewLock = !0) : Ft("rcorner", width / 3 - width / 48, height / 16 + height / 24, width / 48, height) && (Bt.lvl.scroll += At(mouseY - (height / 16 + height / 24 + (height - (height / 16 + height / 24)) / 12 / 2), Bt.lvl.scroll, .5),
    Bt.lvl.scrollNewLock = !0)),
    0 !== Mt() && (Bt.lvl.showLeaderboard && mouseX < width / 3 || !Bt.lvl.showLeaderboard ? Rt.length > (height - (height / 16 + height / 24)) / (height / 12) ? Bt.lvl.scroll += height / 12 / 2 / (height / 12 * (Rt.length - (height - (height / 16 + height / 24)) / (height / 12))) * (height - (height / 16 + height / 24) - (height - (height / 16 + height / 24)) / 12) * (Mt() / 100) : Bt.lvl.scroll += height / 12 / 2 * (Mt() / 100) : Bt.lvl.leaderboardScroll += Mt() / 100),
    Vt *= .25,
    Bt.lvl.scroll = constrain(Bt.lvl.scroll, 0, height - (height / 16 + height / 24 + (height - (height / 16 + height / 24)) / 12)),
    fill(30),
    ...
    fill(255),
    Wt(St.bookmark, "contain", 0, height / 16, height / 24 / 1.5, height / 24 / 1.5),
    fill(255),
    Wt(St.online, "contain", height / 24, height / 16, height / 24 / 1.5, height / 24 / 1.5),
    "lvl" === e ? (fill(255),
    Wt(St.ranked, "contain", height / 24 * 2, height / 16, height / 24 / 1.5, height / 24 / 1.5),
    fill(255),
    Wt(St.sort, "contain", height / 24 * 3, height / 16, height / 24 / 1.5, height / 24 / 1.5),
    fill(255),
    Wt(St.searchFor, "contain", height / 24 * 4, height / 16, height / 24 / 1.5, height / 24 / 1.5)) : "song" === e && (fill(255),
    image(St.sort, height / 24 * 2, height / 16, height / 24 / 1.5, height / 24 / 1.5),
    fill(255),
    Wt(St.searchFor, "contain", height / 24 * 3, height / 16, height / 24 / 1.5, height / 24 / 1.5)),
    pop(),
    fill(255),
    imageMode(CENTER),
    Wt("song" === e ? St.upload : St.edit, "contain", width / 3 - width / 48 / 2, height / 16 + height / 24 / 2, (width / 48 < height / 24 ? width / 48 : height / 24) / 1.5, (width / 48 < height / 24 ? width / 48 : height / 24) / 1.5);
    var w, C, y = "", h = ("lvl" === Bt.screen ? Bt.lvl : Bt.song).sortMode, E = ("lvl" === Bt.screen ? Bt.lvl : Bt.song).tab;
    switch (h) {
    default:
        y = "dateDesc";
        break;
    ...
    "lvl" === e ? (!1 === Bt.side && (Xo(0, height / 16, height / 24, height / 24, Pt("menu_lvl_tab_local", xt), Bt.lvl.tabHighlight, 0),
    Xo(height / 24, height / 16, height / 24, height / 24, Pt("menu_lvl_tab_online", xt), Bt.lvl.tabHighlight, 1),
    Xo(height / 24 * 2, height / 16, height / 24, height / 24, Bt.lvl.showUnranked ? Pt("menu_lvl_showUnranked", xt) : Pt("menu_lvl_hideUnranked", xt), Bt.lvl.tabHighlight, 7),
    Xo(height / 24 * 3, height / 16, height / 24, height / 24, Pt("menu_lvl_sort", xt, Pt("menu_lvl_sort_" + y, xt)), Bt.lvl.tabHighlight, 4),
    Xo(height / 24 * 4, height / 16, height / 24, height / 24, Pt("menu_lvl_searchFor", xt, Pt("menu_lvl_search_" + Bt.lvl.searchMode, xt)), Bt.lvl.tabHighlight, 2)),
    Xo(width / 3 - width / 48, height / 16, width / 48, height / 24, Pt("menu_lvl_new", xt), Bt.lvl.tabHighlight, 3)) : (!1 === Bt.side && (Xo(0, height / 16, height / 24, height / 24, Pt("menu_lvl_tab_bookmarks", xt), Bt.song.tabHighlight, 0),
    Xo(height / 24, height / 16, height / 24, height / 24, Pt("menu_song_tab_online", xt), Bt.song.tabHighlight, 1),
    Xo(height / 24 * 2, height / 16, height / 24, height / 24, Pt("menu_lvl_sort", xt, Pt("menu_lvl_sort_" + y, xt)), Bt.song.tabHighlight, 4),
    Xo(height / 24 * 3, height / 16, height / 24, height / 24, Pt("menu_lvl_searchFor", xt, Pt("menu_lvl_search_" + Bt.song.searchMode, xt)), Bt.song.tabHighlight, 2)),
    Xo(width / 3 - width / 48, height / 16, width / 48, height / 24, "" !== T.uuid ? Pt("menu_lvl_newSong", xt) : Pt("menu_newSong_noAccount", xt), Bt.song.tabHighlight, 3)),
    fill(10),
    rect(height / 24 * ("lvl" === e ? 5 : 4), height / 16, width / 3 - width / 48 - height / 24 * ("lvl" === e ? 5 : 4), height / 24),
    textAlign(LEFT, CENTER),
    "lvl" === e ? (o = 0 === Bt.lvl.search.length ? Pt("menu_lvl_search", xt) : Bt.lvl.search,
    w = 0 === Bt.lvl.search.length && "italics",
    C = 0 === Bt.lvl.search.length ? 127.5 : 255) : "song" === e && (o = 0 === Bt.song.search.length ? Pt("menu_lvl_search", xt) : Bt.song.search,
